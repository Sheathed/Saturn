      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            const Flexible(child: HomePageScreen()),
          ],
        ),
      ),
    );
...
class _HomePageScreenState extends State<HomePageScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: List.generate(_homePage?.sections.length ?? 0, (i) {
          ...
          child: Padding(
            ...
            child: Row(
              children: List.generate((widget.section.items.length) + 1, (j) {
                      ...
                      onPressed: () => Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => Scaffold(
                            appBar: FreezerAppBar(widget.section.title ?? ''),
                            body: SingleChildScrollView(
                              child: HomePageScreen(
                                channel: DeezerChannel(
                                  target: widget.section.pagePath,
                                ),
                              ),
                            ),
                          ),
                ...
                //Show item
                HomePageItem item = widget.section.items[j] ?? HomePageItem();
    ...
    switch (item.type) {
      case HomePageItemType.FLOW:
        return FlowTrackListTile(
          ...
          onTap: () {
            ...
            GetIt.I<AudioPlayerHandler>().playFromSmartTrackList(
              SmartTrackList(
                id: 'flow',
                title: deezerFlow.title,
                flowType: deezerFlow.id,
              ),
            );
          },
        );
        ...
        return AlbumCard(
          ...
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => AlbumDetails(item.value)),
            );
          },
          onHold: () {
      ...
      case HomePageItemType.SHOW:
        return ShowCard(
          ...
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => ShowScreen(item.value)),
            );
          },
        );
      default:

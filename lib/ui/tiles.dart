...
class AlbumTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      subtitle: Text(album.artistString ?? '', maxLines: 1),
      leading: CachedImage(url: album.art?.thumb ?? '', width: 48),
      onTap: onTap,
      onLongPress: onHold,
      trailing: trailing,
    );
...
class PlaylistTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading: CachedImage(url: playlist.image?.thumb ?? '', width: 48),
      onTap: onTap,
      onLongPress: onHold,
      trailing: trailing,
    );
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ListTile(
        ...
        leading: CachedImage(url: artist.picture?.thumb ?? '', circular: true),
        onTap: onTap,
        onLongPress: onHold,
        trailing: trailing,
      ),
                ...
                children: [
                  if (channel.backgroundImage != null)
                    ClipRRect(
                      ...
                      child: CachedImage(
                        url:
                            channel.backgroundImage?.customUrl(
                              '134',
                              '264',
                              quality: '100',
                            ) ??
...
class ShowTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      onTap: onTap,
      onLongPress: onHold,
      leading: CachedImage(url: show.art?.thumb ?? '', width: 48),
    );
  }
}
          ...
          Padding(
            ...
            child: Text(
              ...
              style: TextStyle(
                color: Theme.of(
                  context,
                ).textTheme.titleMedium?.color?.withValues(alpha: 0.9),
              ),
            ),
          ),
          Padding(
